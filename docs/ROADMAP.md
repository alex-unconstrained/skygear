...
> ### ✅ RESOLVED FOR V5+ — upright billboards, 41° deck projection
>
> The engine pitch remains **0.72 rad / 41°** for readable lane depth. Character
> and prop billboards use the accepted **10–15°-above-horizontal**, nearly
> face-on presentation. These are deliberately separate jobs: the renderer
> projects the floor, while a billboard must remain visually upright.
>
> The latest direct player comparison and the live V5 lane composition settle
> the production choice. Literal 40–49° figure bakes read pitched over against
> the deck. The archived 49° set remains comparison evidence only.
...
**1 · Upright 10–15° billboard art is the V5+ keeper.**
The accepted captain and enemies stay readable as standing figures in the live
lane view. Their near-face-on presentation is intentional: the deck projection
already supplies the 41° ground perspective. Do not add crown-heavy top views or
strong body foreshortening to future billboard art.
...
| # | Item |
|---|---|
| 4.1 | Generate the revised 75-image set: the original 66, Furnace Knight back view, and the eight V5 lane additions in `SKYGEAR_V5_LANE_ASSET_AMENDMENT.md`. **External dependency — the long pole.** |
...
| 4.3 | Run the §5 QA checklist per asset — especially the upright 10–15° billboard presentation and the "reads against `#14121B`" test. |
