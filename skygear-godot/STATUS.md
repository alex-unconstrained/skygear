...
board SG-56). **997 harness checks**; the text audit covers 24 screens at
...
`harness` (997 checks), `text` (the audit), `screens` (the BATCH-evidence mode:
...
| `tests/parity_test.gd` | 997 checks; the closest thing to a specification |
...
| | |
|---|---|
| `harness` | 997 checks. Green before anything ships |
