...
board SG-56). **771 harness checks**; the text audit covers 24 screens at
...
`harness` (771 checks), `text` (the audit), `screens` (the BATCH-evidence mode:
...
| `tests/parity_test.gd` | 771 checks; the closest thing to a specification |
...
| | |
|---|---|
| `harness` | 771 checks. Green before anything ships |
