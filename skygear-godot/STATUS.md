...
board SG-56). **1017 harness checks**; the text audit covers 24 screens at
...
`harness` (1017 checks), `text` (the audit), `screens` (the BATCH-evidence mode:
...
| `tests/parity_test.gd` | 1017 checks; the closest thing to a specification |
...
| | |
|---|---|
| `harness` | 1017 checks. Green before anything ships |
