...
board SG-56). **1034 harness checks**; the text audit covers 24 screens at
...
`harness` (1034 checks), `text` (the audit), `screens` (the BATCH-evidence mode:
...
| `tests/parity_test.gd` | 1034 checks; the closest thing to a specification |
...
| | |
|---|---|
| `harness` | 1034 checks. Green before anything ships |
