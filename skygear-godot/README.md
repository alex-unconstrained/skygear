...
684 checks — and a text audit across 24 screens at 4 widths.

Build 41 is on itch: https://alex-unconstrained.itch.io/skygear-godot-test
...
reach for: `harness` (the 684 checks — green before anything ships), `text`
