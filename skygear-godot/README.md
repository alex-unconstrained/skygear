...
a run log, rebindable keys, a cutscene system with all five cues filled, and the
browser's painted sky sampled by view direction. Verified by the harness —
649 checks — and a text audit across 24 screens at 4 widths.

Build 40 is on itch: https://alex-unconstrained.itch.io/skygear-godot-test
...
reach for: `harness` (the 649 checks — green before anything ships), `text`
