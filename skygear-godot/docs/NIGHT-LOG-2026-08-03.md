...
# SG-159 + SG-160 — the two melee heavies, and every arm that was run
...
SG-161, with a second defect in the same function: `_lethal_report` computed
...
audit look thorough. Small blast radius here, unbounded in principle. SG-162.

## SG-159 — the furnace knight
...
the SG-125 failure mode arriving through a decimal point. Annotated at SG-159b.

## SG-160 — the Colossus, and the variance finding
...
knight. Named at SG-161 rather than silently corrected, because changing the
