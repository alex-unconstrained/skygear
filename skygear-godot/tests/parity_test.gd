...
func _bot() -> void:
	...
	## --- board SG-187: EVERY HAND-STEPPING RIG STEPS INSIDE A PHYSICS FRAME ---
	##
	...
	## filed on SG-187 rather than fixed under a bug about the Colossus.
	##
	...
	_check("bot", "a rig that steps a boarder by hand does it inside a physics frame — the SG-187 clock",
